...
public class FuncNavActivity extends BaseActivity{
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.func_nav_activity);
	...
	private void getMenuList() {
		...
		for(int i=0;i<menuArray.size();i++){
			...
			ImageWithTips imageView = new ImageWithTips(this);
			imageView.setImageResource(R.drawable.non_color);
			if("sys_setting".equals(menuCode)){
			...
			imageView.setOnClickListener(new OnClickListener() {
				...
				public void onClick(View arg0) {
					...
					startActivity(new Intent(FuncNavActivity.this,SetUpActivity.class));
				}
	...
	//根据功能点组装页面视图，并放入集合中
		...
		private void initViewPageSwitcher() {
			...
			if(funcNavPageList!=null && funcNavPageList.size()>1) {
				pageSwitchLayout=(LinearLayout)this.findViewById(R.id.func_nav_view_page_switcher);
		...
		private void initViewPager() {
			funcNavPager = (ViewPager) findViewById(R.id.func_nav_view_pager);
