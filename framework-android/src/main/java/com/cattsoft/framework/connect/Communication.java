...
public class Communication {
    ...
    /**
     * @param parameter         请求的json字符串
     * @param serviceName       请求服务端的名称
     * @param requestMethodName 请求方法
     * @param methodName        服务端传来数据后，该Acitivity对数据处理的方法名
     * @param superObject       反射的实例(Activity)，指定是哪个activity
     */
     ...
     * @param url               服务器的地址，直接写Action的地址，如tm/WoHandleAction.do?method=query
     * @param parameter         请求的json字符串
     * @param callbackInterface 服务端传来数据后，该Acitivity对数据处理的方法名
     * @param superObject       反射的实例(Activity)，指定是哪个activity
     */
...
////					Toast.makeText(MosApp.getInstance(),"网络未连接，请检查网络。",Toast.LENGTH_SHORT).show();
//                    toastCommom.ToastShow(MosApp.getInstance(),null,"网络未连接，请检查网络。");
