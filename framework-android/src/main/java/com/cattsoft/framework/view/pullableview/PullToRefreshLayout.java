...
public class PullToRefreshLayout extends RelativeLayout
{
    ...
    private boolean hasLoadmoreView = true;//如果没有在xml中include load_more布局文件，则认为是listview使用footerview方式
    ...
    //解决4.4以下版本如果addFooterView在setAdapter之后会看不到的问题
    private boolean isFooterReady = false;
    public boolean isFooterReady() {
        return isFooterReady;
    }

    public void setFooterReady(boolean isFooterReady) {
        this.isFooterReady = isFooterReady;
    }

    /**
	 * true表示可以加载更多（上拉），这个是为了在具体的Activity里设置不让上拉而设置的变量
	 */
	boolean canLoadMore = true;
	public void setCanLoadMore(boolean canLoadMore) {

        if(!canLoadMore&&!hasLoadmoreView){//listview中的footerview修改显示

            loadStateImageView.setVisibility(View.GONE);
            loadStateTextView.setText("没有更多数据了");
	...
	public void refreshFinish(int refreshResult)
	{
		...
		case SUCCEED:
			...
			refreshStateImageView
					.setBackgroundResource(R.drawable.icon_succeed);
			break;
		case FAIL:
		default:
			// 刷新失败
			...
			refreshStateImageView
					.setBackgroundResource(R.drawable.icon_failed);
			break;
		}
		if (pullDownY > 0)
		{
	...
	public void loadmoreFinish(int refreshResult)
	{
		...
		case SUCCEED:
            ...
            if(hasLoadmoreView){
                ...
                loadStateImageView.setBackgroundResource(R.drawable.icon_succeed);
            }else{//如果是listview布局，则恢复原始状态
		...
		default:
            ...
            if(hasLoadmoreView) {
                ...
                loadStateImageView.setBackgroundResource(R.drawable.icon_failed);
            } else {//如果是listview布局，则恢复原始状态
...
//			hide();
//			pullUpView.setVisibility(View.INVISIBLE);
//			loadStateTextView.setText(null);
	...
	protected void onLayout(boolean changed, int l, int t, int r, int b)
	{
		...
		if (!isLayout)
		{
            ...
            if(loadmoreView==null){
                ...
                loadmoreView =  View.inflate(MosApp.getInstance(), R.layout.load_more, null);
				//加载点击事件
                ...
                ((ListView)pullableView).addFooterView(loadmoreView);

//                int count = ((ListView)pullableView).getFooterViewsCount();
//
//                loadmoreView =
            ...
            Log.d("====","loadmoreDist"+loadmoreDist);
